...
export const CLIENT_DATABASE: Record<string, any> = {
  "Fufu-Fafa": {
    ...
    gallery: [
      ...
      { url: "https://images.unsplash.com/photo-1596457221755-b96bc3a6df18?w=600&q=80", label: "Cinta Abadi" },
      { url: "https://images.unsplash.com/photo-1563808599481-34a32e44508k?w=600&q=80", label: "Bersama Selamanya" }
    ],

mapsUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!...", // Masukkan link EMBED/IFRAME dari Google Maps nanti
loveStory: [
...
accounts: [
  ...
  // Kalau ada klien kedua, kamu tinggal tambah koma (,) di bawah sini lalu buat key baru:
  // "budi-siti": { ... data milik budi dan siti }
};